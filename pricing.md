...
<div class="pricing-container">
    <!-- Banner pointing to Services and Portfolio pages -->
    <div class="services-banner">
        <p>Want more service details? <a href="{{ site.baseurl }}/services/">Explore our services page</a> or <a href="{{ site.baseurl }}/portfolio/">view my work</a></p>
    </div>
    ...
    <div class="pricing-section industry-packages-section">
        <div class="container">
            ...
            <div class="pricing-plans">
                ...
                <div id="property-manager-package" class="pricing-plan">
    ...
    <div class="pricing-section payment-options-section">
        <div class="container">
            ...
            <div class="grid grid-3">
                ...
                <div class="card card-bordered">
                    <div class="card-content">
                        <h3 class="card-title">Billing Frequency</h3>
                        <ul>
